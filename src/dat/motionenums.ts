/** Generated from ACE MotionCommand.cs. */
export const MotionCommandNames: Record<number, string> = {
  0x00000000: "Invalid",
  0x85000001: "HoldRun",
  ...
  0x080000a2: "Cancel",
  0x090000a3: "UseSelected",
  0x090000a4: "AutosortSelected",
  0x090000a5: "DropSelected",
  0x090000a6: "GiveSelected",
  0x090000a7: "SplitSelected",
  0x090000a8: "ExamineSelected",
  0x080000a9: "CreateShortcutToSelected",
  0x090000aa: "PreviousCompassItem",
  0x090000ab: "NextCompassItem",
  0x090000ac: "ClosestCompassItem",
  0x090000ad: "PreviousSelection",
  0x090000ae: "LastAttacker",
  0x090000af: "PreviousFellow",
  0x090000b0: "NextFellow",
  0x090000b1: "ToggleCombat",
  0x0d0000b2: "HighAttack",
  0x0d0000b3: "MediumAttack",
  0x0d0000b4: "LowAttack",
  0x080000b5: "EnterChat",
  0x080000b6: "ToggleChat",
  0x080000b7: "SavePosition",
  0x090000b8: "OptionsPanel",
  0x090000b9: "ResetView",
  0x0d0000ba: "CameraLeftRotate",
  0x0d0000bb: "CameraRightRotate",
  0x0d0000bc: "CameraRaise",
  0x0d0000bd: "CameraLower",
  0x0d0000be: "CameraCloser",
  0x0d0000bf: "CameraFarther",
  0x090000c0: "FloorView",
  0x0c0000c1: "MouseLook",
  0x090000c2: "PreviousItem",
  0x090000c3: "NextItem",
  0x090000c4: "ClosestItem",
  0x0d0000c5: "ShiftView",
  0x090000c6: "MapView",
  0x090000c7: "AutoRun",
  0x090000c8: "DecreasePowerSetting",
  0x090000c9: "IncreasePowerSetting",
  0x130000ca: "Pray",
  0x130000cb: "Mock",
  0x130000cc: "Teapot",
  ...
  0x090000d5: "FirstPersonView",
  0x090000d6: "AllegiancePanel",
  0x090000d7: "FellowshipPanel",
  0x090000d8: "SpellbookPanel",
  0x090000d9: "SpellComponentsPanel",
  0x090000da: "HousePanel",
  0x090000db: "AttributesPanel",
  0x090000dc: "SkillsPanel",
  0x090000dd: "MapPanel",
  0x090000de: "InventoryPanel",
  0x120000df: "Demonet",
  ...
  0x090000e7: "CaptureScreenshotToFile",
  ...
  0x090000fe: "AutoCreateShortcuts",
  0x090000ff: "AutoRepeatAttacks",
  0x09000100: "AutoTarget",
  0x09000101: "AdvancedCombatInterface",
  0x09000102: "IgnoreAllegianceRequests",
  0x09000103: "IgnoreFellowshipRequests",
  0x09000104: "InvertMouseLook",
  0x09000105: "LetPlayersGiveYouItems",
  0x09000106: "AutoTrackCombatTargets",
  0x09000107: "DisplayTooltips",
  0x09000108: "AttemptToDeceivePlayers",
  0x09000109: "RunAsDefaultMovement",
  0x0900010a: "StayInChatModeAfterSend",
  0x0900010b: "RightClickToMouseLook",
  0x0900010c: "VividTargetIndicator",
  0x0900010d: "SelectSelf",
  0x1000010e: "SkillHealSelf",
  0x1000010f: "SkillHealOther",
  0x09000110: "PreviousMonster",
  0x09000111: "ClosestMonster",
  0x09000112: "NextPlayer",
  0x09000113: "PreviousPlayer",
  0x09000114: "ClosestPlayer",
  0x43000118: "SnowAngelState",
  0x13000119: "WarmHands",
  0x4300011a: "CurtseyState",
  0x4300011b: "AFKState",
  0x4300011c: "MeditateState",
  0x0900011d: "TradePanel",
  0x1000011e: "LogOut",
  ...
  0x09000154: "CharacterOptionsPanel",
  0x09000155: "SoundAndGraphicsPanel",
  0x09000156: "HelpfulSpellsPanel",
  0x09000157: "HarmfulSpellsPanel",
  0x09000158: "CharacterInformationPanel",
  0x09000159: "LinkStatusPanel",
  0x0900015a: "VitaePanel",
  0x0900015b: "ShareFellowshipXP",
  0x0900015c: "ShareFellowshipLoot",
  0x0900015d: "AcceptCorpseLooting",
  0x0900015e: "IgnoreTradeRequests",
  0x0900015f: "DisableWeather",
  0x09000160: "DisableHouseEffect",
  0x09000161: "SideBySideVitals",
  0x09000162: "ShowRadarCoordinates",
  0x09000163: "ShowSpellDurations",
  0x09000164: "MuteOnLosingFocus",
  0x10000165: "Fishing",
  0x10000166: "MarketplaceRecall",
  0x10000167: "EnterPKLite",
  0x09000168: "AllegianceChat",
  0x09000169: "AutomaticallyAcceptFellowshipRequests",
  0x0900016a: "Reply",
  0x0900016b: "MonarchReply",
  0x0900016c: "PatronReply",
  0x0900016d: "ToggleCraftingChanceOfSuccessDialog",
  0x0900016e: "UseClosestUnopenedCorpse",
  0x0900016f: "UseNextUnopenedCorpse",
  0x09000170: "IssueSlashCommand",
...
/** Generated from ACE MotionStance.cs. */
export const MotionStanceNames: Record<number, string> = {
  0x80000000: "Invalid",
  0x8000003c: "HandCombat",
  0x8000003d: "NonCombat",
  0x8000003e: "SwordCombat",
...
export const MotionStance = { Invalid: 0x80000000, HandCombat: 0x8000003c, NonCombat: 0x8000003d } as const;

export function motionKey(stance: number, motion: number): number {
  return ((stance << 16) | (motion & 0xfffff)) >>> 0;
}

const byLow16 = new Map<number, number>();
for (const k of Object.keys(MotionCommandNames)) {
  const id = Number(k);
  if (!byLow16.has(id & 0xffff)) byLow16.set(id & 0xffff, id);
}
/** Recover a full MotionCommand id from the low 16 bits stored in a motion-table key. */
export function commandFromKey(key: number): number {
  const low = key & 0xffff;
  return byLow16.get(low) ?? ((0x40000000 | low) >>> 0);
}
export function stanceFromKey(key: number): number {
  return ((key >>> 16) | 0x80000000) >>> 0;
}
